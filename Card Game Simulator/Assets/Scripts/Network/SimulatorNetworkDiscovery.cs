...
public class SimulatorNetworkDiscovery : NetworkDiscoveryBase<DiscoveryRequest, DiscoveryResponse>
{
    ...
    protected override DiscoveryResponse ProcessRequest(DiscoveryRequest request, IPEndPoint endpoint)
    {
        ...
        {
            Debug.LogError("Attempting to sent DiscoveryResponse to client, but CurrentPlayingGameTemplate is null");
            return new DiscoveryResponse();
        }
    }
    ...
    protected override void ProcessResponse(DiscoveryResponse response, IPEndPoint endpoint)
    {
        ...
        UriBuilder realUri = new UriBuilder(response.uri) { Host = response.EndPoint.Address.ToString() };
